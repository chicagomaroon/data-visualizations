...
2. `HighCharts`: [Link](https://www.highcharts.com/)
   ...
   - If any questions come from the `HighCharts` or `UChicago` legal department regarding this license, please reference this `HighCharts` support request number: `75825`
