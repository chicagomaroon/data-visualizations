const config = [
    ...
    },
    {
        ...
        subsections: [
            ...
            {
                id: '6.2',
                text: `Recent actions leave many wary of the University’s commitment to change. The opening of the Woodlawn Charter School in 2018 on 63rd Street broke the <a href = "https://chicagomaroon.com/25412/news/uchicago-charter-schools-opens-new-woodlawn-campus/" target = "_blank">decades-old agreement</a> with The Woodlawn Organization for the University not to extend further into Woodlawn. In 2020, then-President Zimmer and incoming President Paul Alivisatos <a href = "https://news.uchicago.edu/story/council-examine-history-relationship-between-university-chicago-and-south-side-communities' target = "_blank">committed</a> to exploring and addressing the University’s historical relationship with its surrounding neighborhoods by launching the Council on UChicago/Community Relations tasked with examining the role the University has had to its South Side neighbors historically. However, as of 2023, after the Council's first two years, it was <a href ='https://chicagomaroon.com/40648/news/community-relations-council-tries-to-tackle-public-safety-and-displacement/' target = "_blank">not yet prepared to engage meaningfully with the public</a> but that outreach could begin soon.
`
            },
            {
                id: '6.3',
                text: ` These actions recall those of the University's past actions, and some see them as confirmation that the University is continuing to privilege its well-being over that of the community. The next decade represents a crucial chapter in the ongoing story of the University of Chicago’s involvement in shaping its surrounding neighborhoods. From its neo-Gothic beginnings to its perch as an Ivy Plus university, the University and the South Side have been—and will continue to be—intertwined.`
            },
            {
                id: 'final-scroller',
                text: ``
