 ...
 */ (function (e) {
    ...
    function w(_, b) {
        ...
        try {
            for (
                p(b), m = n(s);
                m !== null && (!(m.expirationTime > b) || (_ && !B()));

            ) {
                var X = m.callback;
                if (typeof X == 'function') {
                    (m.callback = null), (h = m.priorityLevel);
                    var te = X(m.expirationTime <= b);
                    (b = e.unstable_now()),
                        typeof te == 'function'
                            ? (m.callback = te)
                            : m === n(s) && r(s),
    ...
    Mf(function () {
        ...
        e: {
            ...
            if (h !== void 0) {
                ...
                0 < y.length &&
                    ((h = new v(h, x, null, n, c)),
                    m.push({ event: h, listeners: y }));
            }
        }
        if (!(t & 7)) {
            e: {
                ...
                if (
                    ...
                    if (
                        ...
                        t: {
                            for (y = v, d = x, f = 0, p = y; p; p = an(p)) f++;
...
function Sc(e) {
    ...
    function o(d, f, p, g) {
        return f === null || f.tag !== 6
            ? ((f = Wi(p, d.mode, g)), (f.return = d), f)
            : ((f = a(f, p)), (f.return = d), f);
    }
    function s(d, f, p, g) {
        var w = p.type;
        return w === un
            ...
            : f !== null &&
              (f.elementType === w ||
                  (typeof w == 'object' &&
                      ...
                      w.$$typeof === vt &&
                      Xs(w) === f.type))
            ? ((g = a(f, p.props)), (g.ref = Yn(d, f, p)), (g.return = d), g)
            : ((g = wa(p.type, p.key, p.props, null, d.mode, g)),
              (g.ref = Yn(d, f, p)),
              (g.return = d),
              g);
    }
    function u(d, f, p, g) {
        return f === null ||
            ...
            ? ((f = Hi(p, d.mode, g)), (f.return = d), f)
            : ((f = a(f, p.children || [])), (f.return = d), f);
    }
    function c(d, f, p, g, w) {
        return f === null || f.tag !== 7
            ? ((f = Qt(p, d.mode, g, w)), (f.return = d), f)
            : ((f = a(f, p)), (f.return = d), f);
    }
    function m(d, f, p) {
        if ((typeof f == 'string' && f !== '') || typeof f == 'number')
            return (f = Wi('' + f, d.mode, p)), (f.return = d), f;
        if (typeof f == 'object' && f !== null) {
            switch (f.$$typeof) {
                case Hr:
                    return (
                        (p = wa(f.type, f.key, f.props, null, d.mode, p)),
                        (p.ref = Yn(d, null, f)),
                        (p.return = d),
                        p
                    );
            ...
            if (Zn(f) || Un(f))
                return (f = Qt(f, d.mode, p, null)), (f.return = d), f;
            ea(d, f);
        }
        return null;
    }
    function h(d, f, p, g) {
        ...
        if ((typeof p == 'string' && p !== '') || typeof p == 'number')
            return w !== null ? null : o(d, f, '' + p, g);
        if (typeof p == 'object' && p !== null) {
            switch (p.$$typeof) {
                case Hr:
                    return p.key === w ? s(d, f, p, g) : null;
                case sn:
                    return p.key === w ? u(d, f, p, g) : null;
                case vt:
                    return (w = p._init), h(d, f, w(p._payload), g);
            }
            if (Zn(p) || Un(p)) return w !== null ? null : c(d, f, p, g, null);
            ea(d, p);
        }
        return null;
    }
    function v(d, f, p, g, w) {
        if ((typeof g == 'string' && g !== '') || typeof g == 'number')
            return (d = d.get(p) || null), o(f, d, '' + g, w);
        if (typeof g == 'object' && g !== null) {
            switch (g.$$typeof) {
                ...
                case vt:
                    var C = g._init;
                    return v(d, f, p, C(g._payload), w);
            }
            if (Zn(g) || Un(g))
                return (d = d.get(p) || null), c(f, d, g, w, null);
            ea(f, g);
        }
        return null;
    }
    function x(d, f, p, g) {
        ...
        if (j === p.length) return n(d, N), V && $t(d, j), w;
        if (N === null) {
            for (; j < p.length; j++)
                (N = m(d, p[j], g)),
                    N !== null &&
    ...
    function y(d, f, p, g) {
        ...
        for (
            var C = (w = null), N = f, j = (f = 0), D = null, T = p.next();
            N !== null && !T.done;
            j++, T = p.next()
        ) {
            N.index > j ? ((D = N), (N = null)) : (D = N.sibling);
            var B = h(d, N, T.value, g);
            if (B === null) {
                N === null && (N = D);
                break;
            }
            ...
            switch (p.$$typeof) {
                case Hr:
                    e: {
                        ...
                        p.type === un
                            ? ((f = Qt(p.props.children, d.mode, g, p.key)),
                              (f.return = d),
                              (d = f))
                            : ((g = wa(
                                  p.type,
                ...
                case sn:
                    e: {
                        ...
                        (f = Hi(p, d.mode, g)), (f.return = d), (d = f);
                    }
                    return l(d);
                case vt:
                    return (C = p._init), I(d, f, C(p._payload), g);
            }
            if (Zn(p)) return x(d, f, p, g);
            if (Un(p)) return y(d, f, p, g);
            ea(d, p);
        }
        return (typeof p == 'string' && p !== '') || typeof p == 'number'
            ? ((p = '' + p),
              f !== null && f.tag === 6
                  ? (n(d, f.sibling), (f = a(f, p)), (f.return = d), (d = f))
                  : (n(d, f), (f = Wi(p, d.mode, g)), (f.return = d), (d = f)),
              l(d))
            : n(d, f);
    }
    return I;
...
function Rc(e, t, n) {
    return (
        (n = n != null ? n.concat([e]) : null), ri(4, 4, Fc.bind(null, t, e), n)
    );
}
function Wo() {}
function Mc(e, t) {
...
var Ua = {
    ...
    Ph = {
        ...
        useTransition: function () {
            var e = qs(!1),
                t = e[0];
            return (e = Eh.bind(null, e[1])), (Ke().memoizedState = e), [t, e];
        },
...
function su(e, t, n, r, a) {
    ...
    if ((_n(t, a), t.stateNode === null))
        ...
        (l.state = h),
            Ma(t, r, l, a),
            (s = t.memoizedState),
            o !== r || h !== s || ye.current || gt
                ? (typeof c == 'function' &&
                      (Nl(t, n, c, r), (s = t.memoizedState)),
                  (o = gt || tu(t, n, o, r, h, s, u))
                      ? (m ||
        ...
        o !== m || h !== x || ye.current || gt
            ? (typeof v == 'function' &&
                  (Nl(t, n, v, r), (x = t.memoizedState)),
              (u = gt || tu(t, n, u, r, h, x, s) || !1)
                  ? (c ||
...
function Th(e, t, n, r, a, i, l) {
    ...
    if (a.data === '$!') {
        ...
        return (
            (r = o), (i = Error(S(419))), (r = $i(i, r, void 0)), ta(e, t, l, r)
        );
    }
...
function hi(e) {
    var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
        ...
        c = u === void 0 ? null : u,
        m = py(i),
        h = E(E({}, my(l)), {}, { prefix: mi(c, { family: m }) });
    return E(
        E(
            E({}, h),
            yy({
...
function Jl(e) {
    ...
    if (t)
        return (
            (t = Vt(n, t) || t), Ou(hp.definitions, n, t) || Ou($e.styles, n, t)
        );
}
var hp = new wy(),
    ky = function () {
...
function fs(e) {
    ...
    var d = E(
        ...
        p = f.children,
        g = f.attributes;
    return (d.children = p), (d.attributes = g), o ? Ny(d) : Py(d);
}
function Mu(e) {
    var t = e.content,
        n = e.width,
    ...
    var m = [];
    return m.push({ tag: 'span', attributes: s, children: [t] }), m;
}
function Iy(e) {
    var t = e.content,
        n = e.extra,
...
function Wu(e) {
    if (Pu && A.observeMutations) {
        ...
        (Ga = new Pu(function (u) {
            if (!ds) {
                var c = Ot();
                Dn(u).forEach(function (m) {
                    if (
                        (m.type === 'childList' &&
                            m.addedNodes.length > 0 &&
                            !$u(m.addedNodes[0]) &&
                            (A.searchPseudoElements && l(m.target),
                            n(m.target)),
                        m.type === 'attributes' &&
                            m.target.parentNode &&
                        ...
                        m.type === 'attributes' &&
                            $u(m.target) &&
                            ~Qg.indexOf(m.attributeName))
                    )
                        if (m.attributeName === 'class' && Oy(m.target)) {
                            var h = hi(ls(m.target)),
                                v = h.prefix,
                                x = h.iconName;
                            m.target.setAttribute(rs, v || c),
                                x && m.target.setAttribute(as, x);
                        } else Ly(m.target) && a(m.target);
                });
            }
        })),
            mt &&
...
function Bu(e) {
    ...
    var n = H.documentElement.classList,
        r = function (m) {
            return n.add(''.concat(Iu, '-').concat(m));
        },
        a = function (m) {
            return n.remove(''.concat(Iu, '-').concat(m));
        },
            ...
            return vi(E({ type: 'icon' }, t), function () {
                return (
                    ...
                    fs({
                        ...
                        symbol: l,
                        maskId: c,
                        extra: { attributes: x, styles: I, classes: h }
                    })
                );
            });
        }
...
function Qu(e, t) {
    ...
    return new Promise(function (r, a) {
        ...
        if (u && m !== 'none' && m !== '') {
            ...
            if (y) {
                var p = dy(x);
                p.iconName && p.prefix && ((d = p.iconName), (v = p.prefix));
            }
            if (
                d &&
                !I &&
        ...
        provides: function (t) {
            t.generateAbstractMask = function (n) {
                var r = n.children,
                    ...
                    m = l.width,
                    h = l.icon,
                    v = ny({ transform: s, containerWidth: m, iconWidth: u }),
                    x = {
                        tag: 'rect',
                        attributes: E(E({}, Xi), {}, { fill: 'white' })
                    },
                    y = c.children ? { children: c.children.map(Zu) } : {},
                    I = {
                        tag: 'g',
                        attributes: E({}, v.inner),
                        children: [
    ...
    for (; n < r; ) {
        ...
        if (l) {
            ...
            if (o > 0) {
                ...
                if (s && u) {
                    const c = Ep(s);
                    t[c.startsWith('webkit') ? g0(c) : c] = u;
                }
            }
        }
        n = i + 1;
...
function Cp(e, t, n = {}) {
    if (typeof t == 'string') return t;
    const r = (t.children || []).map((c) => Cp(e, c)),
        a = t.attributes || {},
        i = {};
...
var ef = new S0('FontAwesomeIcon'),
    ...
    Pp = Te.forwardRef((e, t) => {
        const n = { ..._p, ...e },
            ...
            m = Ju(o, !!l),
            h = qu(r);
        if (!h) return ef.error('Icon lookup is undefined', r), null;
        const v = j0(n),
        ...
        if (!I) return ef.error('Could not find icon', h), null;
        const { abstract: d } = I,
            f = { ref: t };
        for (const p of A0(n)) T0.has(p) || (f[p] = n[p]);
        return x0(d[0], f);
    });
...
const L0 =
    ...
    t1 = ({ windowWidth: e, windowHeight: t }) =>
        k.jsxs('div', {
    ...
    if (!n) {
        ...
        const i = new IntersectionObserver((l) => {
            l.forEach((o) => {
                var s;
                const u =
                    o.isIntersecting && a.some((c) => o.intersectionRatio >= c);
                e.trackVisibility &&
...
function lf({
    ...
    (v.current = u),
                ...
                (p = w1(
                    ...
                    (g, w) => {
                        y({ inView: g, entry: w }),
                            ...
                            w.isIntersecting && i && p && (p(), (p = void 0));
                    },
                    {
                        root: a,
                        rootMargin: r,
        ...
        }, [Array.isArray(e) ? e.toString() : e, m, a, r, i, l, n, s, t]);
    const I = (c = x.entry) == null ? void 0 : c.target,
        d = R.useRef(void 0);
    !m &&
        I &&
        !i &&
                ...
                function () {
                    if (N) {
                        var Ye = rn.target.getBoundingClientRect(),
                            ...
                            L = Math.min(
                                1,
                                Math.max(0, (window.innerHeight * h - b) / _)
                            );
                        m &&
                            m({
                                progress: L,
...
const Gn = (e) => {
    ...
    k1 = ({ currentStepIndex: e }) =>
        k.jsxs('div', {
            className:
                'sticky top-0 h-screen w-full relative flex items-center justify-center',
            children: [
                k.jsx('img', {
                    src: 'love.jpg',
                    alt: 'image1',
    ...
    P1 = ({ currentStepIndex: e }) => {
        const t = Te.useRef(null);
        return (
            R.useEffect(() => {
                t.current &&
                    (e >= 5 && e < 8 ? t.current.play() : t.current.pause());
            }, [e]),
            k.jsxs('div', {
                className:
...
function N1({ windowHeight: e }) {
    const n = e * 1.1,
        ...
        [i, l] = R.useState(() => {
            ...
            return u !== null && r > 2e3 ? parseInt(u) : 0;
        });
    R.useEffect(() => {
        localStorage.setItem('currentStepIndex', i.toString());
    }, [i]),
        R.useEffect(() => {
            localStorage.setItem('scrollY', r.toString());
        }, [r]),
        R.useEffect(() => {
            const u = () => {
                a(window.scrollY);
    ...
    const o = ({ data: u }) => {
        ...
        s = ({ data: u, direction: c }) => {
            c === 'up' ? l(u - 1) : c === 'down' && l(u);
        };
    return k.jsxs('div', {
        ...
        children: [
                ...
                children: [
                    F0.map((u, c) =>
                        k.jsx(
                            ...
                            {
                                className:
                                    'mb-[20px] px-[2%] lg:px-[20%] z-[20]',
                                dangerouslySetInnerHTML: { __html: u }
                            },
                            c
                        )
                    ),
                    k.jsx(k1, { currentStepIndex: i }),
                    k.jsx(Gn, {
                        onStepEnter: o,
                        onStepExit: s,
                        textArray: R0,
            ...
            k.jsxs('div', {
                className:
                    'w-[95dvw] mx-auto md:py-10 flex flex-col items-center',
                children: [
                    M0.map((u, c) =>
                        k.jsx(
                            'p',
            ...
            k.jsxs('div', {
                className:
                    'w-[95dvw] mx-auto mt-10 md:py-10 flex flex-col items-center',
                children: [
                    $0.map((u, c) =>
                        k.jsx(
                            'p',
            ...
            k.jsxs('div', {
                className: 'w-[95dvw] mx-auto py-1 md:py-10 flex flex-col',
                children: [
                    W0.map((u, c) =>
                        k.jsx(
                            'p',
    ...
    return (
        R.useEffect(() => {
            ...
            function i() {
                ...
                l !== a && (t(l), r(window.innerHeight), (a = l));
            }
            return (
        ...
        k.jsxs('div', {
            children: [
                k.jsx(t1, { windowWidth: e, windowHeight: n }),
                k.jsx(N1, { windowHeight: n }),
                k.jsx(j1, {})
            ]
        })
    );
