!(function (e, t) {
    ...
    return function () {
        ...
        function P(e, t) {
            ...
            var o = { element: e, index: n, progress: l[n].progress };
        ...
        function q(e, t) {
            ...
            h &&
                ('down' === t && l[o].progress < 1
                    ? P(e, 1)
                    : 'up' === t && l[o].progress > 0 && P(e, 0)),
                (l[o].direction = t),
                (l[o].state = 'exit'),
                r.stepExit(i, l),
        ...
        return (
            ...
            (J.offsetTrigger = function (e) {
                ...
                if ('number' == typeof e)
                    (I = 'percent'),
                        e > 1 &&
                            C('offset value is greater than 1. Fallback to 1.'),
                        e < 0 &&
                            C('offset value is lower than 0. Fallback to 0.'),
