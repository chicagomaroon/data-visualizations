...
export const methodologySampleSubhead =
    'What schools and which years are included in the data?';
...
export const methodologyClassificationSubhead =
...
export const methodologyMeasurementSubhead =
    'How is the size of a major measured?';
