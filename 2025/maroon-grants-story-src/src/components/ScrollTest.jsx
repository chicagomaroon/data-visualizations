...
import {
    ...
    method
} from '../../public/data/scrollContent';
    ...
    return (
        <div>
            <div className="credits_container">
                ...
                <p className="credits_font">
                    Cover photo by{' '}
                    <a href="https://chicagomaroon.com/staff_name/damian-almeida-baray/">
...
export const TreemapAnimations = ({
    currentStepIndex,
    scrollY,
    direction,
    highlighted = []
    ...
    return (
        <div className="scroll__graphic">
            ...
            >
                <h1 id="graphic_title" style={{ opacity: 2.5 - scrollY / 500 }}>
                    ...
                    <div className="inner_body_container">
                        ...
                        <div className="inner_body_container">
                            ...
                            <div className="inner_body_container">
                                ...
                                <TreemapAnimations
                                    currentStepIndex={currentStepIndex + 4}
                                    direction={direction}
                                    scrollY={scrollY}
                                />
                                <ScrollContainer
