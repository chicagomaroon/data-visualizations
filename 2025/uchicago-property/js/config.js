        ...
        subsections: [
            {
                ...
                With the <a href = "https://chicagomaroon.com/41032/grey-city/the-obama-center-a-welcome-neighbor/" target = "_blank">opening of the Obama Presidential Center</a> nearing, the University is once again in a position to make decisions that will significantly impact neighborhood’s future. 
                
                The University, while a minor donor to the Center, is poised to benefit from the estimated <a href = "https://www.obama.org/press-releases/obama-presidential-center-estimated-support-thousands-jobs-city-chicago-south-side-construction-ten-years-operations/" target = "_blank">$3.1 billion in “economic impact”</a> it will bring. The Center joins large-scale university-owned projects that are expected to impact the South Side in coming years, including <a href = "https://hydeparklabs.com/" target = "_blank">Hyde Park Labs</a> and UCMed’s <a href = "https://news.uchicago.edu/story/state-approves-uchicago-medicines-plan-build-citys-first-freestanding-cancer-care-and" target = "_blank">Cancer Pavilion</a>.
